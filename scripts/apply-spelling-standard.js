...
const PHRASE_REPLACEMENTS = [
  ...
  ['पधाारो', 'पधारो'],
  ['कष्ण', 'कृष्ण'],
  ['सूख सम्पत्ति', 'सुख सम्पत्ति'],
  ['बधाावसां', 'बधावसां'],
  ['बधाावन', 'बधावन'],
  ['निसदिन', 'निशिदिन'],
  ['निशदिन', 'निशिदिन'],
  ['मांग सिंदूर', 'माँग सिंदूर'],
  ['खड्ग खप्पर', 'खडग खपर'],
  ['कण्ठन पर साजै', 'कण्ठन पर छाजै'],
  ['सुख-संपति', 'सुख सम्पत्ति'],
  ['सुख संपति', 'सुख सम्पत्ति'],
  ['सुख संपित', 'सुख सम्पत्ति'],
  ['हरि ब्रह्मा शिवरी', 'हरि ब्रह्मा शिव री'],
...
const REPLACEMENTS = [
  ...
  { from: 'मां', to: 'माँ' },
  { from: 'हां', to: 'हाँ' },
  { from: 'योगिनी', to: 'योगिनि' },
  { from: 'हिमगिरी', to: 'हिमगिरि' },
  { from: 'अंबे', to: 'अम्बे' },
];
